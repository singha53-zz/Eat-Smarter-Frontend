$(document).ready(function () {
  ...
  $(document).on("click", ".recipe", function (event) {
    ...
    getRecipes(url).then(res => {
      ...
      console.log("Image:" + res.images[0].hostedMediumUrl)
      console.log("Link:" + res.source.sourceRecipeUrl)
  ...
  async function getRecipes(url) {
    ...
    function addImages(course, recipe) {
      ...
      <div class="card-stacked" >
        <div class="card-content" id="drag1" draggable="true" ondragstart="drag(event)">
